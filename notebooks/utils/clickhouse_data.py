...
def clickhouse_data(ticker_path, start_date, end_date):
    ...
    WHERE financialinstrumentid IN {tuple(financialinstrumentid_list[:1])} AND date BETWEEN '{start_date}' AND '{end_date}'
...
def clickhouse_largecap(start_date, end_date):
    largecap_ticker_path = "/Users/akash/personal/finance/technical-analysis/data/metadata/largecap.csv"
    return clickhouse_data(largecap_ticker_path, start_date, end_date)
